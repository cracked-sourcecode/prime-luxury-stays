...
const adminTranslations = {
  ...
  de: {
    ...
    // WIP (Work In Progress) - German translations
    wip: 'WIP',
    wipTitle: 'Aufgabenliste',
    wipSubtitle: 'Aufgaben, Prioritäten und Teamzuweisungen verfolgen',
    ...
    immediateNextAction: 'Was ist der nächste Schritt?',
    anyAdditionalContext: 'Zusätzlicher Kontext...',
    updateTask: 'Aufgabe aktualisieren',
    completedTasks: 'Erledigte Aufgaben',
    reopen: 'Wiedereröffnen',
    showingOf: 'Zeige',
    ofActive: 'von',
    activeTasksLabel: 'aktiven Aufgaben',
...
// Add English WIP translations
const wipTranslationsEn = {
  wip: 'WIP',
  wipTitle: 'Work In Progress',
  wipSubtitle: 'Track tasks, priorities, and team assignments',
  ...
  immediateNextAction: "What's the immediate next action?",
  anyAdditionalContext: 'Any additional context...',
...
// Merge WIP translations into English
Object.assign(adminTranslations.en, wipTranslationsEn)
